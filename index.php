		...
		<div class="mdui-container-fluid">
					...
					<div class="mdui-card">
						...
						<div class="mdui-card-primary">
							<div class="mdui-card-primary-title">
								<?php if(!isset($code))echo "请选择文件"; ?>
							</div>
							<div class="mdui-card-primary-title">
								<?php if(isset($code) && $code==0) out_success( "上传成功");if(isset($code)
								&& $code!=0) out_error( "上传失败"); ?>
							</div>
							<div class="mdui-card-primary-subtitle">
								<?php echo isset($code)? $msg: "文件大小限制最大为2M"; ?>
							</div>
						</div>
						...
						<div class="mdui-card-content">
							<form action="" method="post" enctype="multipart/form-data">
								...
								<input class="mdui-btn mdui-btn-raised mdui-ripple" type="file" name="file" />
								<br /><br />
			...
			<div class="mdui-dialog" id="aboutDialog">
				...
				<div id="example4-tab1" class="mdui-p-a-2" align="center">
					<p>From 商丘学院</p>
					<p>&copy;2019 InSQU. All Rights Reserved.</p>
				</div>
			</div>
			<!-- 上传提示-->
			<div class="mdui-dialog" id="uploadDialog">
				...
				<div class="mdui-dialog-content">
					<span>当你看到这个界面时,就说明你的上传网速较慢或文件较大,请稍候文件的上传。</span>
					<br />
					<span>文件上传过程中请<b>不要</b>尝试其他操作！！！</span>
					<br /><br />
					<span>如果本页面超过1分钟未响应,请尝试手动刷新并重试。</span>
					<br />
